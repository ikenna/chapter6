...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2023-01-01T13:31:20.229219Z[Europe/London]")
public class Product {
  ...
  */
  @NotNull @Min(1) @Max(5) 
  @Schema(name = "reviewRating", example = "5", description = "Average product review rating.", required = true)
